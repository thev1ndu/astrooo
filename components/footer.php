            ...
            <div class="d-flex flex-column gap-3">
               <div class="d-flex align-items-center gap-3">
                  ...
                  <div style="color: #999999;">
                     Rajagiriya,<br>Colombo, Sri Lanka
                  </div>
               </div>
               <div class="d-flex align-items-center gap-3">
                  <div style="width: 40px; height: 40px; background-color: rgba(255,255,255,0.1); border-radius: 8px; display: flex; align-items: center; justify-content: center;">
                  ...
                  <div style="color: #999999;">
                  <a href="tel:+94705555555" style="text-decoration: none; color: #999999;">+94 70 555 5555</a><br><a href="tel:+94705555555" style="text-decoration: none; color: #999999;">+94 70 555 5556</a>
                  </div>
               </div>
               <div class="d-flex align-items-center gap-3">
                  <div style="width: 40px; height: 40px; background-color: rgba(255,255,255,0.1); border-radius: 8px; display: flex; align-items: center; justify-content: center;">
                  ...
                  <div style="color: #999999;">
                     <a href="mailto:contact@astroshop.lk" style="text-decoration: none; color: #999999;">contact@astro.store</a>
                  </div>
               </div>
            </div>
         </div>
      ...
      <div class="row align-items-center">
         <div class="col-md-6 text-center text-md-start mb-3 mb-md-0">
            <p class="mb-0" style="color: #999999;">
               Copyright © <span style="color: #0d6efd;"><?= date('Y'); ?></span> AstroShop. All rights reserved.
            </p>
         </div>
